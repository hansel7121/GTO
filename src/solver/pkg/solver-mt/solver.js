...
import { startWorkers } from './snippets/solver-9ec3a3d9d4184257/workerHelpers.js';
import * as import1 from "./snippets/solver-9ec3a3d9d4184257/workerHelpers.js"
...
export class GameManager {
    ...
    init(oop_range, ip_range, board, starting_pot, effective_stack, rake_rate, rake_cap, donk_option, oop_flop_bet, oop_flop_raise, oop_turn_bet, oop_turn_raise, oop_turn_donk, oop_river_bet, oop_river_raise, oop_river_donk, ip_flop_bet, ip_flop_raise, ip_turn_bet, ip_turn_raise, ip_river_bet, ip_river_raise, add_allin_threshold, force_allin_threshold, merging_threshold, added_lines, removed_lines, max_raises) {
        ...
        const ret = wasm.gamemanager_init(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, starting_pot, effective_stack, rake_rate, rake_cap, donk_option, ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6, ptr7, len7, ptr8, len8, ptr9, len9, ptr10, len10, ptr11, len11, ptr12, len12, ptr13, len13, ptr14, len14, ptr15, len15, ptr16, len16, add_allin_threshold, force_allin_threshold, merging_threshold, ptr17, len17, ptr18, len18, max_raises);
        let v20;
        if (ret[0] !== 0) {
            v20 = getStringFromWasm0(ret[0], ret[1]);
...
function __wbg_get_imports(memory) {
    const import0 = {
        ...
        __wbg_startWorkers_ab516cdc0d31e724: function(arg0, arg1, arg2) {
    ...
    return {
        ...
        "./snippets/solver-9ec3a3d9d4184257/workerHelpers.js": import1,
    };
}
